...
eachLCA = lapply(trainlist, function(x) Mclust(scale(na.omit(x[,c(2, 11, 17, 5, 6)])), modelName = c('EII', 'VII', 'EEI', 'VEI', 'EVI', 'VVI'))) 
...
# as.vector(cor(nalist$p242[,c(1:7, 10:17)])[14,2])
# 
...
#   groupdata[i, 47] = as.vector(cor(nalist[[paste(groupdata$id[i])]][,c(1:7, 10:17)])[12,2])
#   groupdata[i, 48] = as.vector(cor(nalist[[paste(groupdata$id[i])]][,c(1:7, 10:17)])[14,2])
# }
# 
# colnames(groupdata)[24:48] = c('hrrsa', 'hrpep', 'rsapep',
#                                'hrslope', 'rsaslope', 'pepslope', 'svslope', 'coslope', 'rrslope', 'ampslope',
#                                'hr', 'rsa', 'pep', 'sv', 'co', 'rate', 'amp',
#                                'hrmssd', 'hrar', 'sdhr', 'hrrange',
#                                'cl5hr', 'cl7hr','cl5rsa', 'cl7rsa')

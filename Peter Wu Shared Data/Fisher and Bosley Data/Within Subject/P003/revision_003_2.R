...
set.seed(1234)
regL1=cv.glmnet(matL1.1,trainL0$class1,family='binomial',standardize=T,alpha=.0004)
...
#best   -0.469435   0.6923077   0.7692308
#best.1 -0.469306   0.7692308   0.6923077
...
set.seed(1234)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.00004)

...
dati <- InsertRow(dati, NewRow=new, RowNum = 14)
dati <- InsertRow(dati, NewRow=new, RowNum = 18)
dati$start
...
summary(ICL)
blrt=mclustBootstrapLRT(clustdat, maxG=2, modelName = "VII")
blrt

#Save best model as an object
mod <- Mclust(clustdat, G = 2, modelName = "VII")

...
dati <- InsertRow(dati, NewRow=new, RowNum = 102)
dati <- InsertRow(dati, NewRow=new, RowNum = 123)
dati$start
...
#summary(Mclust(clustdat, G=5, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) 
...
mod <- Mclust(clustdat, G = 3, modelName = "VII")
...
set.seed(1234)
regL3=cv.glmnet(matL1.1,trainL0$class3,family='binomial',standardize=T,alpha=.000045)

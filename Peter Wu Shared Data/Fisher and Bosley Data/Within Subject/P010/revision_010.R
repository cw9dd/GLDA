...
dati <- InsertRow(dati, NewRow=new, RowNum = 121)
...
summary(Mclust(clustdat, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) #min class size = 7

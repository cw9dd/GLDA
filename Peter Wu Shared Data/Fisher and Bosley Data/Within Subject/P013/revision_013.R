...
dati <- InsertRow(dati, NewRow=new, RowNum = 110)
dati <- InsertRow(dati, NewRow=new, RowNum = 112)
dati <- InsertRow(dati, NewRow=new, RowNum = 119)
dati$start
...
set.seed(1234)
regL1=cv.glmnet(matL1.1,trainL0$class1,family='binomial',standardize=T,alpha=.00015)
...
set.seed(1234)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.00015)
...
set.seed(1234)
regL3=cv.glmnet(matL1.1,trainL0$class3,family='binomial',standardize=T,alpha=.00015)

...
dati <- InsertRow(dati, NewRow=new, RowNum = 21)
dati <- InsertRow(dati, NewRow=new, RowNum = 25)
dati <- InsertRow(dati, NewRow=new, RowNum = 29)
dati <- InsertRow(dati, NewRow=new, RowNum = 33)
dati <- InsertRow(dati, NewRow=new, RowNum = 34)
dati$start
...
mod <- Mclust(clustdat, G = 2, modelName = "VVI")

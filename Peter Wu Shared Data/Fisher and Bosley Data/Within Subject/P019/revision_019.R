...
summary(Mclust(clustdat, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) #min class size = 8
summary(Mclust(clustdat, G=3, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) #min class size = 8
summary(Mclust(clustdat, G=2, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI")))

#Verify model selection via BIC, ICL, and BLRT
BIC <- mclustBIC(clustdat,G=c(1,2,3), modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))
summary(BIC)

...
dati <- InsertRow(dati, NewRow=new, RowNum = 17)
dati <- InsertRow(dati, NewRow=new, RowNum = 115)
dati$start
...
summary(Mclust(clustdat, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) #Classes 3/4 nearly identical
summary(Mclust(clustdat, G=3, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) 
#summary(Mclust(clustdat, G=3, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI"))) 
#summary(Mclust(clustdat, G=2, modelName = c("EEI", "VII", "EEI", "VEI", "EVI", "VVI")))
...
summary(ICL)
blrt=mclustBootstrapLRT(clustdat, maxG=3, modelName = "VEI")
blrt

#Save best model as an object
mod <- Mclust(clustdat, G = 3, modelName = "VEI")
...
means$Class=recode(means$Class, X1 = "1", X2 = "2", X2 = "3")
...
#  threshold specificity sensitivity 
#best   -0.4363404   0.7083333   0.9166667
#best.1  0.1291032   0.7916667   0.8333333

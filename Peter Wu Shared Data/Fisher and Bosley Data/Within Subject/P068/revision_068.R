...
dati <- InsertRow(dati, NewRow=new, RowNum = 8)
dati <- InsertRow(dati, NewRow=new, RowNum = 24)
dati <- InsertRow(dati, NewRow=new, RowNum = 80)
dati=dati[-57,]
dati <- InsertRow(dati, NewRow=new, RowNum = 101)
dati <- InsertRow(dati, NewRow=new, RowNum = 103)
dati$start
...
summary(ICL)
blrt=mclustBootstrapLRT(clustdat, maxG=5, modelName = "VEI")
blrt
...
#      threshold specificity sensitivity
#best  -2.313144   0.8571429   0.8888889

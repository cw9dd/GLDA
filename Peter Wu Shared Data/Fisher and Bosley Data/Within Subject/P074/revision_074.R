...
dati <- InsertRow(dati, NewRow=new, RowNum = 124)
dati=dati[-125,]
dati$start
...
set.seed(1234)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.0006)
...
#      threshold specificity sensitivity
#best -0.8669786   0.8076923   0.6666667

...
dati <- InsertRow(dati, NewRow=new, RowNum = 148)
dati=dati[-149,]
dati$start
...
set.seed(1234)
regL1=cv.glmnet(matL1.1,trainL0$class1,family='binomial',standardize=T,alpha=.01)
...
#best   -0.8644813   0.6428571   1.0000000
#best.1 -0.7373543   0.7142857   0.9285714
#best.2 -0.5747863   0.7857143   0.8571429
...
set.seed(1234)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.01)
...
#      threshold specificity sensitivity
#best   0.5747863   0.8571429   0.7857143
#best.1 0.7373543   0.9285714   0.7142857
#best.2 0.8644813   1.0000000   0.6428571

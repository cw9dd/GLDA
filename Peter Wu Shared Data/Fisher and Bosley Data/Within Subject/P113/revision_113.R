...
dati=dati[-103,]
dati <- InsertRow(dati, NewRow=new, RowNum = 108)
...
#        1         2         3         4
#0.1206047 0.1556550 0.2010983 0.5226420 
...
set.seed(1234)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.0001)
...
set.seed(1234)
regL4=cv.glmnet(matL1.1,trainL0$class4,family='binomial',standardize=T,alpha=.0)

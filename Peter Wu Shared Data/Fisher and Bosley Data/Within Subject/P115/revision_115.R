...
dati <- InsertRow(dati, NewRow=new, RowNum = 104)
dati <- InsertRow(dati, NewRow=new, RowNum = 105)
...
#best -0.9734393   0.6666667   0.9333333
...
#      threshold specificity sensitivity
#best   -0.3333123   0.8571429   1.0000000
#best.1  0.2581898   0.9285714   0.9285714

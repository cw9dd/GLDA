...
dati <- InsertRow(dati, NewRow=new, RowNum = 101)
dati <- InsertRow(dati, NewRow=new, RowNum = 107)
dati <- InsertRow(dati, NewRow=new, RowNum = 135)
dati$start
...
#best -0.4768428   0.9166667      0.8125

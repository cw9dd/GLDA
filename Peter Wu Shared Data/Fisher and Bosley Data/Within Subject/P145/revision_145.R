...
dati <- InsertRow(dati, NewRow=new, RowNum = 139)
dati$start
...
#best -0.6032912   0.9090909   0.6666667
...
set.seed(1234)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.25)

...
#        1         2         3         4
#0.24033745 0.45681125 0.09795909 0.20489221 
...
set.seed(123)
regL2=cv.glmnet(matL1.1,trainL0$class2,family='binomial',standardize=T,alpha=.1)
...
set.seed(123)
regL4=cv.glmnet(matL1.1,trainL0$class4,family='binomial',standardize=T,alpha=.25)

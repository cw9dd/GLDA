...
#        1         2         3         4
#0.3796786 0.1290475 0.3331038 0.1581702
...
#best 1.451331   0.6842105   0.6923077
...
set.seed(1234)
regL4=cv.glmnet(matL1.1,trainL0$class4,family='binomial',standardize=T,alpha=.0001)
